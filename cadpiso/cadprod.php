...
<head>
    ...
    <title>Cadastro dos Pisos</title>
            ...
            <form name = "form1" method="post" class = "form-group row" enctype="multipart/form-data" action="./gravarProd.php">
                <div class="form-group row mt-3">
                    ...
                    <div class = "col-sm-10 mb-4">
                        <input type="text" name = "nome_Prod" class = "select" placeholder = "Pisos">
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class=""><h5>Descrição:</h5></label>
                        <div class="col-sm-5">
                            <select class='select' id='inputGroupSelect01' name = 'desc' type = 'text'>
